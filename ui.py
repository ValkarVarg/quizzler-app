...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain) -> None:
        ...
        self.true_button = Button(image=true_image, highlightthickness=0, command=lambda: self.give_feedback(self.quiz.check_answer("True")))
        self.true_button.grid(row=2, column=0)

        self.false_button = Button(image=false_image, highlightthickness=0, command=lambda: self.give_feedback(self.quiz.check_answer("False")))
    ...
    def get_next_question(self):
        ...
        self.canvas.itemconfig(fill=THEME_COLOR)
